...
enum SystemSettings {
    enum Page: String, CaseIterable {
        case wifi, network, battery, vpn, soundOutput, sound, focus, menubar
        ...
        var title: String {
            ...
            case .soundOutput: return "声音输出设置"
        ...
        var url: URL {
            ...
            case .soundOutput: target = "com.apple.Sound-Settings.extension?output"
