...
本机在 macOS 26.6.2 出现过 DuoBar 开关开启、图标仍被控制中心阻止的情况。实际验证发现系统将 DuoBar 关联到了 ChatGPT 的菜单栏权限：开启“系统设置 → 菜单栏 → 允许在菜单栏中 → ChatGPT”后图标立即恢复。此处理需要保持关联应用的开关开启；未修改或重置系统的应用关联记录。
