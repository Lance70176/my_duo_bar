...
xcrun swiftc "${DUOBAR_TEST_FLAGS[@]}" -parse-as-library \
    ...
    "$DUOBAR_ROOT/Sources/L10n.swift" "$DUOBAR_ROOT/Sources/StatusModel.swift" "$DUOBAR_ROOT/Sources/IconPreferences.swift" "$DUOBAR_ROOT/Sources/TunnelRoutes.swift" "$DUOBAR_ROOT/Sources/WiFiNetworks.swift" "$DUOBAR_ROOT/Sources/ChargeLimitService.swift" "$DUOBAR_ROOT/Tests/StatusTests.swift" \
...
xcrun swiftc -O "${DUOBAR_TEST_FLAGS[@]}" -module-cache-path "$DUOBAR_ROOT/build/module-cache" \
    "$DUOBAR_ROOT/Sources/L10n.swift" "$DUOBAR_ROOT/Sources/StatusModel.swift" "$DUOBAR_ROOT/Sources/IconPreferences.swift" \
...
xcrun swiftc -O "${DUOBAR_TEST_FLAGS[@]}" -module-cache-path "$DUOBAR_ROOT/build/module-cache" \
    ...
    "$DUOBAR_ROOT/Sources/SystemReaders.swift" "$DUOBAR_ROOT/Sources/TunnelRoutes.swift" "$DUOBAR_ROOT/Sources/SoundService.swift" "$DUOBAR_ROOT/Sources/SoundMenu.swift" "$DUOBAR_ROOT/Sources/BluetoothService.swift" "$DUOBAR_ROOT/Sources/BLEBattery.swift" "$DUOBAR_ROOT/Sources/BluetoothMenu.swift" \
    "$DUOBAR_ROOT/Sources/ChargeLimitService.swift" "$DUOBAR_ROOT/Sources/BatteryMenu.swift" \
