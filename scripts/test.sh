...
xcrun swiftc "${DUOBAR_TEST_FLAGS[@]}" -parse-as-library \
    ...
    "$DUOBAR_ROOT/Sources/L10n.swift" "$DUOBAR_ROOT/Sources/StatusModel.swift" "$DUOBAR_ROOT/Sources/IconPreferences.swift" "$DUOBAR_ROOT/Sources/TunnelRoutes.swift" "$DUOBAR_ROOT/Sources/WiFiNetworks.swift" "$DUOBAR_ROOT/Tests/StatusTests.swift" \
